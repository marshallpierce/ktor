...
internal class JettyHttpRequest(
    ...
    internal suspend fun execute(): HttpResponse {
        ...
        val responseListener = JettyResponseListener(session, bodyChannel, callContext)
        ...
        return JettyHttpResponse(call, status, headers, requestTime, bodyChannel, origin, callContext)
    }
    ...
    private fun ByteReadChannel.writeResponse(request: JettyHttp2Request) = GlobalScope.launch(callContext) {
